...
| `FE_PREMIUM_SUM_ALL_REAL_2022` | Сумма премий в руб. 2022 | `PREMIUM_SUM_ALL / CPI` по T0 |
| `FE_PREMIUM_PER_POLICY` | Премия на полис | `FE_PREMIUM_SUM_ALL_REAL_2022 / PREMIUM_COUNT_ALL` |
...
| `FE_VALUE_BEFORE_WITHOUT_BIN` | Бакет без износа (руб. 2022) | пороги 120k/365k на `*_REAL_2022` |
| `FE_HIGH_VALUE_BEFORE_WITHOUT` | Дорогая калькуляция без износа | `*_REAL_2022 > 365000` |
| `FE_VALUE_BEFORE_WITH_BIN` | Бакет с износом (руб. 2022) | те же пороги на `*_REAL_2022` |
| `FE_HIGH_VALUE_BEFORE_WITH` | Дорогая калькуляция с износом | `*_REAL_2022 > 365000` |
| `FE_VALUE_BEFORE_WITH_REAL_2022` | VALUE_BEFORE_WITH в руб. 2022 | `nominal / CPI` (Росстат Dec/Dec, базис 2022=1) |
| `FE_VALUE_BEFORE_WITHOUT_REAL_2022` | VALUE_BEFORE_WITHOUT в руб. 2022 | то же |
...
> ИПЦ: для applicant/payment_recipient сумм `PRETENSION_VALUE` / `SURCHARGE_VALUE` пишутся `*_REAL_2022` (дефляция по T0); номинал в `TO_DROP`.
